...
class Activate
{
    ...
    {
        global $wpdb;
        $wpdb->query('TRUNCATE TABLE '.$wpdb->prefix.'scw_gdprc_config');
        $wpdb->query('TRUNCATE TABLE '.$wpdb->prefix.'scw_gdprc_snippets');
        $wpdb->query('TRUNCATE TABLE '.$wpdb->prefix.'scw_gdprc_snippet_cookies');
        $wpdb->query('TRUNCATE TABLE '.$wpdb->prefix.'scw_gdprc_snippet_variables');
    }
    ...
    private function buildDatabaseTables()
    {
        ...
        $table_name = $wpdb->prefix.'scw_gdprc_config';
        ...
        $table_name = $wpdb->prefix.'scw_gdprc_snippets';
        $sql = "CREATE TABLE $table_name (
            id mediumint(9) NOT NULL AUTO_INCREMENT,
        ...
        $table_name = $wpdb->prefix.'scw_gdprc_snippet_cookies';
        $sql = "CREATE TABLE $table_name (
            id mediumint(9) NOT NULL AUTO_INCREMENT,
        ...
        $table_name = $wpdb->prefix.'scw_gdprc_snippet_variables';
        $sql = "CREATE TABLE $table_name (
            id mediumint(9) NOT NULL AUTO_INCREMENT,
            snippet_id int(11) NOT NULL,
    ...
    private function importDatabaseData() {
        ...
        foreach ($snippets as $snippet) {
            $wpdb->insert($wpdb->prefix.'scw_gdprc_snippets', array(
                'title'   => $snippet['title'],
                'slug'    => $snippet['slug'],
                'label'   => $snippet['label'],
            ...
            foreach ($snippet['cookies'] as $key => $cookie) {
                ...
                $wpdb->insert($wpdb->prefix.'scw_gdprc_snippet_cookies', array(
            ...
            foreach ($snippet['variables'] as $variable) {
                $wpdb->insert($wpdb->prefix.'scw_gdprc_snippet_variables', array(
                    'snippet_id'  => $snippetId,
